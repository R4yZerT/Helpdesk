// RF-32 — Admin móvil: categorías maestras ticket_categories (paridad web, CSV only)
  ...
  const onExportCsv = useCallback(async () => {
    try {
      ...
      if (Platform.OS !== 'web') {
        ...
        setFeedback({ visible: true, variant: 'success', title: `CSV listo para compartir: ${exportRows.length} filas.` });
        return;
      }
