// RF-24 web — Alertas IA dirigidas al jefe: lista, genera y resuelve.
// Paridad con apps/mobile AlertasIAScreen; reutiliza helpers shared (dashboard.ts) y TimelineAlertas.
