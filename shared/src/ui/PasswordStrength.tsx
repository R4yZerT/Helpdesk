// Fortaleza contraseña — NIST 800-63B feedback sin composition enforcement
import { StyleSheet, Text, View } from 'react-native';
import { theme } from './theme.js';
import type { PasswordValidation } from '../password.js';
import { strengthLabel } from '../password.js';
...
export function PasswordStrength({ validation }: { validation: PasswordValidation | null }) {
  ...
  return (
    <View style={s.wrap}>
      <View style={s.barBg}>
        <View style={[s.barFill, { width: `${pct}%` as unknown as number, backgroundColor: COLORS[validation.strength] }]} />
      </View>
